      ...
      <div className={styles["content"]}>
        <div className={styles["form-block"]}>
          ...
          <div className={styles["checkbox-block"]}>
            ...
            <label>
              Отправляя запрос, вы соглашаетесь на обработку своих персональных
              данных, отправленных в вышеуказанной форме. Администратором ваших
              личных данных является Migrant Expert Sp. z о. о. Подробнее о RODO
